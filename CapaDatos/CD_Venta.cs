                    ...
                    using (XmlReader dr = cmd.ExecuteXmlReader())
                    {
                        while (dr.Read())
                        {
                            ...
                            if (doc.Element("DETALLE_VENTA") != null)
                            {
                                ...
                                rptDetalleVenta.oTransportista = (from dato in doc.Element("DETALLE_VENTA").Elements("DETALLE_TRANSPORTISTA")
                ...
                try
                {
                    ...
                    while (dr.Read())
                    {
                        rptListaVenta.Add(new Venta()
                        {
                            ...
                            oTransportista = new Transportista() { NumeroDocumento = dr["NumeroDocumento"].ToString(), Nombre = dr["Nombre"].ToString() },
